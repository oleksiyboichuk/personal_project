				...
				{data &&
					<div key={data[0].id} className='flex flex-col bg-white drop-shadow-xl h-[100vh]'>
						<div className='flex items-center flex-col md:flex-row'>
							<img src={data[0].image_url} alt={data[0].name} className='max-w-[600px] mb-4 md:mb-0 md:mr-4' />
							<div className='flex flex-col items-start'>
								...
								<div className='flex flex-col flex-start'>
									...
									<button className={`${isExists ? 'bg-black/10 text-black' : 'bg-green-500 text-white hover:scale-105'}  text-2xl font-semibold px-4 py-1 my-4 rounded-lg drop-shadow-xl transition-slow`} onClick={() => addToCart(data[0])}>
						...
						<Wrapper>
							<div className='flex flex-col md:flex-row justify-center items-baseline gap-5 rounded-lg'>
								<div className='bg-white px-4 py-2 min-w-full md:min-w-[250px] min-h-[250px] rounded-lg drop-shadow-xl'>
									<div className='p-2'>
										<h2 className='text-3xl font-semibold font-story text-main'>Grind Option :</h2>
										<ul>
								...
								<div className='bg-white px-4 py-2 min-w-full md:min-w-[250px] min-h-[250px] rounded-lg drop-shadow-xl'>
									<div className='p-2'>
										<h2 className='text-3xl font-semibold font-story text-main'>Flavor :</h2>
										<ul>
								...
								<div className='bg-white px-4 py-2 min-w-full md:min-w-[250px] min-h-[250px] rounded-lg drop-shadow-xl'>
									<div className='p-2'>
										<h2 className='text-3xl font-semibold font-story text-main'>Weight :</h2>
								...
								<div className='bg-white px-4 py-2 min-w-full md:min-w-[250px] min-h-[250px] rounded-lg drop-shadow-xl'>
									<div className='p-2'>
										<h2 className='text-3xl font-semibold font-story text-main'>Region :</h2>
